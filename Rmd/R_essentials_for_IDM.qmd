...
The most common data types you will be working with are: *vectors*, *lists*, and *matrices*, *data frames*. More information on data types in *R* can be found in many places on the web, for example the [R programming wikibook](http://en.wikibooks.org/wiki/R_Programming/Data_types).
